...
2.run ActivateCondaEnv batch file to open miniconda command prompt
3.run SetupCondaEnv batch file inside the command prompt to create the project's anaconda environment
